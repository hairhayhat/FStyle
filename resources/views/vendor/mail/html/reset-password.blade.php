...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <p>Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn tại
            ...
            <div class="panel">
                ⏳ Liên kết này sẽ hết hạn sau {{ $expire ?? 60 }} phút vì lý do bảo mật.
            </div>

            <p>Nếu bạn không yêu cầu thay đổi mật khẩu, bạn có thể bỏ qua email này hoặc <a
                    href="{{ config('app.url') }}/contact">liên hệ với chúng tôi</a>.</p>
