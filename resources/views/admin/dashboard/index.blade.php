    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <a href="{{ route('admin.chart.order') }}" class="text-decoration-none">
                        <div class="b-b-primary border-5 border-0 card o-hidden">
                            <div class="custome-1-bg b-r-4 card-body">
                                <div class="media align-items-center static-top-widget">
                                    <div class="media-body p-0">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <a href="{{ route('admin.chart.comment') }}" class="text-decoration-none">
                        <div class="b-b-primary border-5 border-0 card o-hidden">
                            <div class="custome-1-bg b-r-4 card-body">
                                <div class="media align-items-center static-top-widget">
                                    <div class="media-body p-0">
                                        <span class="m-0">Tổng số đánh giá</span>
                                        <h4 class="mb-0 counter">{{ $commentCount }}</h4>
                                    </div>
                                    <div class="align-self-center text-center">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <a href="{{ route('admin.chart.user') }}" class="text-decoration-none">
                        <div class="b-b-primary border-5 border-0 card o-hidden">
                            <div class="custome-1-bg b-r-4 card-body">
                                <div class="media align-items-center static-top-widget">
                                    <div class="media-body p-0">
                                        <span class="m-0">Tổng số người dùng</span>
                                        <h4 class="mb-0 counter">{{ $userCount }}</h4>
                                    </div>
                                    <div class="align-self-center text-center">
