                        ...
                        <div class="menu-left">
                            <div class="brand-logo">
                                <a href="index.html">
                                    ...
                                    <img src="client/assets/assets/images/logo.png" class="img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="category-banner">
                                                                <img src="client/assets/assets/images/electronics/banner/4.jpg"
                                            ...
                                            <ul class="category-mega-menu">
                                                <li>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="category-banner">
                                                                <img src="client/assets/assets/images/banner/1.jpg"
                                                                    class="img-fluid blur-up lazyload" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="flower-demo.html"
                                                                                class="megamenu-image">
                                                                                <img src="client/assets/assets/images/demo-image/flower.jpg"
                                                                                    class="img-fluid blur-up lazyload"
                                                                                    alt="">
                                                                            </a>
                                                                        </li>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="furniture-demo.html"
                                                                                class="megamenu-image">
                                                                                <img src="client/assets/assets/images/demo-image/furniture.jpg"
                                                                                    class="img-fluid blur-up lazyload"
                                                                                    alt="">
                                                                            </a>
                                                                        </li>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="electronic-demo.html"
                                                                                class="megamenu-image">
                                                                                <img src="client/assets/assets/images/demo-image/electonic.jpg"
                                                                                    class="img-fluid blur-up lazyload"
                                                                                    alt="">
                                                                            </a>
                                                                        </li>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="shoes-demo.html"
                                                                                class="megamenu-image">
                                                                                <img src="client/assets/assets/images/demo-image/shoes.jpg"
                                                                                    class="img-fluid blur-up lazyload"
                                                                                    alt="">
                                                                            </a>
                                                                        </li>
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="vegetables-demo.html"
                                                                                class="megamenu-image">
                                                                                <img src="client/assets/assets/images/demo-image/vagetables.jpg"
                                                                                    class="img-fluid blur-up lazyload"
                                                                                    alt="">
                                                                            </a>
                                                                        </li>
                                    ...
                                    <div class="onhover-div">
                                        <div class="cart-menu">
                                            ...
                                            <ul class="custom-scroll">
                                                <li>
                                                    <div class="media">
                                                        <img src="client/assets/assets/images/fashion/product/front/1.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <img src="client/assets/assets/images/fashion/product/front/7.jpg"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                        <div class="media-body">
                                ...
                                <ul class="custom-scroll">
                                    <li>
                                        <div class="product-cart media">
                                            <img src="client/assets/assets/images/electronics/product/1.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="product-cart media">
                                            <img src="client/assets/assets/images/electronics/product/5.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <div class="media-body">
                                                <a href="javascript:void(0)">
