                    ...
                    <div class="home-slider">
                        <div class="home-wrap row m-0">
                                            ...
                                            <ul class="share-icons p-0">
                                                <li>
                                                    <a target="_blank"
                                                        ...
                                                        <img src="client/assets/images/social-icon/4.png"
                                                            class="img-fluid blur-up lazyload" alt="social icon">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="https://www.google.co.in/">
                                                        <img src="client/assets/images/social-icon/5.png"
                                                            class="img-fluid blur-up lazyload" alt="social icon">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="http://www.twitter.com/share">
                                                        <img src="client/assets/images/social-icon/6.png"
                                                            class="img-fluid blur-up lazyload" alt="social icon">
                                                    </a>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-xxl-9 col-lg-8 p-0 left-content">
                                <img src="client/assets/images/fashion/slider/1.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                                <div class="home-content row">
                                    <div class="col-xxl-4 col-lg-4 col-md-4 col-sm-5 col-6">
                                        <h3>Sale <span class="theme-color">70% OFF</span></h3>
                                        <h1 data-animation-in="fadeInUp">New Tranding Fashion
                                        </h1>
                ...
                <div>
                    <div class="home-slider">
                        <div class="home-wrap row m-0">
                            ...
                            <div class="col-xxl-9 col-lg-8 p-0 left-content">
                                <img src="client/assets/images/fashion/slider/2.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                                <div class="home-content row">
                                    <div class="col-xxl-4 col-lg-5 col-md-6 col-sm-7 col-9">
                                        ...
                                        <h6 class="mb-4" data-animation-in="fadeInUp" data-delay-in="0.4">BUY ONE
                                            GET
                                            ONE <span class="theme-color">FREE</span></h6>
                                        <div class="discover-block" data-animation-in="fadeInUp" data-delay-in="0.7">
                                            <div class="d-flex">
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="client/assets/images/fashion/banner/1.jpg" class="bg-img blur-up lazyload" alt="">
                        </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="client/assets/images/fashion/banner/2.jpg" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-detail">
                            <a href="javacript:void(0)" class="heart-wishlist">
                                <i class="far fa-heart"></i>
                ...
                <div class="col-lg-4">
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="client/assets/images/fashion/banner/3.jpg" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-detail">
                            <a href="javacript:void(0)" class="heart-wishlist">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="category-wrapper category-slider1 white-arrow category-arrow">
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="client/assets/images/fashion/category/1.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="client/assets/images/fashion/category/2.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="client/assets/images/fashion/category/3.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
                        ...
                        <div>
                            <a href="shop-left-sidebar.html" class="category-wrap category-padding">
                                <img src="client/assets/images/fashion/category/4.jpg" class="bg-img blur-up lazyload"
                                    alt="category image">
                                <div class="category-content category-text-1">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="title title-2 text-center">
                        <h2>New Offers</h2>
                        <h5 class="text-color">Just For You</h5>
                    </div>
                </div>
            </div>
            <div class="row gy-4">
                <div class="col-lg-6 ratio2_1">
                    <div class="collection-banner p-right text-right">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="client/assets/images/fashion/banner/4.jpg" class="bg-img blur-up lazyload" alt="">
                        </a>
                        <div class="banner-text">
                            <div class="banner-content">
                                <span class="span-top">New <span class="theme-color">Collections</span></span>
                                <h2> New Red Jackets from <span class="theme-color">$48</span></h2>
                    ...
                    <div class="row gy-4">
                        <div class="col-lg-12 ratio_40">
                            <div class="collection-banner p-left banner-title">
                                <a href="shop-left-sidebar.html" class="banner-img">
                                    <img src="client/assets/images/fashion/banner/5.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="banner-text">
                                    <div class="banner-content">
                                        <h3 class="h-bottom">New Hoodies from <span class="theme-color">$34</span>
                                        </h3>
                                        <button onclick="location.href = 'shop-left-sidebar.html';" type="button"
                                            class="btn btn-solid-default">Shop Now</button>
                                    </div>
                        ...
                        <div class="col-sm-6 ratio2_3">
                            <div class="collection-banner p-center text-center">
                                <a href="shop-left-sidebar.html" class="banner-img">
                                    <img src="client/assets/images/fashion/banner/6.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                </a>
                                <a href="shop-left-sidebar.html" class="contain-banner">
                        ...
                        <div class="col-sm-6 ratio2_3">
                            <div class="collection-banner p-center text-center">
                                <a href="shop-left-sidebar.html" class="banner-img">
                                    <img src="client/assets/images/fashion/banner/7.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                </a>
                                <a href="shop-left-sidebar.html" class="contain-banner">
                                    <div class="banner-content with-bg">
                        ...
                        <div class="col-xl-3 col-lg-4 col-6">
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="product-left-sidebar.html" class="font-default">
                                            <h5>Full Slive Black T-Shirt</h5>
                                        </a>
                                        <div class="listing-content">
            ...
            <div class="row gy-3">
                <div class="col-lg-12">
                    <div class="discount-image-details discount-spacing">
                        <img src="client/assets/images/fashion/banner/8.jpg" class="bg-img blur-up lazyload" alt="">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="share share-box share-opacity">
                                            <span class="share-plus share-plus-color">+</span>
                                            <span>Share</span>
                                        </div>
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="client/assets/images/fashion/instagram/1.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="client/assets/images/fashion/instagram/2.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="client/assets/images/fashion/instagram/3.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="client/assets/images/fashion/instagram/4.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <a href="javascript:void(0)" class="text-center">
                                            <img src="client/assets/images/fashion/instagram/5.jpg"
                                                class="bg-img blur-up lazyload" alt="">
                                        </a>
                                    </div>
                                    <div class="insta-hover insta-spacing text-center">
